<li class="success-element" id="task1">
    <div class="row">
        ...
        <div class="col-lg-6 text-center ">
            Tipe Order<br>
            <b><?php echo $s[$i]->namaKategoriProduksi ?></b>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span >NO PO : <b class="text-success"><?php echo $s[$i]->nomorPO ?></b> | TIPE : <b class="text-success"><?php echo $s[$i]->namaKategoriProduksi ?></b></span><br>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 text-center">
                                            ...
                                            <img src="<?php echo base_url('uploads/gambarProduk/'.$s[$i]->gambar)?>" class="img-responsive">
                                        </div>
                                        <div class="col-lg-4 text-center">
                                    ...
                                    <table class="table table-hover table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Sales</td>
                                                <td class="text-center"><?php echo $s[$i]->tglmsk?></td>
