                            ...
                            <?php echo form_open_multipart('user/tambahPOMasal','class="form-horizontal"')?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Gambar Desain</label>
                                    <div class="col-sm-10" id="desainBelum">
                                        ...
                                        <input type="file" name="userfile" required="" value="<?php echo set_value('userfile'); ?>">
                                    </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Berat Akhir</label>
                                    <div class="col-sm-10"><input type="text" name="berat" class="form-control" value="<?php echo set_value('berat'); ?>" placeholder="500gr" required=""></div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $("#pilih").on('click', function () {
            ...
            $.ajax({
                    ...
                    url: '<?php echo base_url();?>po/cariProduk',
                    type: 'post',
