<?php 
    ...
    $tanggalEstimasiPenyelesaian = $dataPO[0]->tanggalPenyelesaian;
    ...
    $idProduk               = $dataPO[0]->idProdukHeader;
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="<?php echo base_url();?>PO/list">Purchase Order</a>
                    </li>
                    <li class="active">
                        <strong><a >Request For Quotation</a></strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="wrapper wrapper-content animated fadeInUp">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <img src="<?php echo base_url('uploads/gambarProduk/'.$kodeGambar)?>" class="img img-responsive pull-right" style="max-height: 125px;">
                                </div>
